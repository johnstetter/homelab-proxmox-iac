...
# Base template for creating new Proxmox-based projects
...
resource "local_file" "project_private_key" {
  ...
  filename        = "${path.module}/ssh_keys/project_private_key.pem"
...
resource "local_file" "project_public_key" {
  ...
  filename        = "${path.module}/ssh_keys/project_public_key.pub"
...
# Example VM deployment using shared module
...
#   ip_address     = "${var.vm_ip_base}${count.index + 1}/${var.network_cidr}"
...
# Generate Ansible inventory file template
# Uncomment and modify as needed

# resource "local_file" "ansible_inventory" {
#   content = templatefile("${path.module}/templates/inventory.tpl", {
#     vms             = module.project_vms[*]
#     ssh_user        = var.ssh_user
#     ssh_private_key = "${path.module}/ssh_keys/project_private_key.pem"
#   })
